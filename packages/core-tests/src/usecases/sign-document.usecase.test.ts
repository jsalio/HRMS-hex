...
import { SignDocumentUseCase } from '@hrms/core/usecases/sign-document.usecase'
import { ValidationError } from '@hrms/core/domain/errors'
import type { SignDocumentRepository, EmployeeDocumentData } from '@hrms/core/contracts/documents'
