...
import { AbsenceBalance, assertCanApprove, assertCanReject, assertCanCancel, calculateWorkingDays } from '@hrms/core/domain/absence-balance'
import { ValidationError } from '@hrms/core/domain/errors'
import type { AbsenceBalanceData, AbsenceRequestData } from '@hrms/core/contracts/absences'
